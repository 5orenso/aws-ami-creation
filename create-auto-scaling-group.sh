...
AG_RUN_OUTPUT=$(aws autoscaling create-auto-scaling-group \
    ...
    --tags ResourceId=$AUTO_SCALING_GROUP_NAME,ResourceType=auto-scaling-group,Key=Role,Value=${LAUNCH_CONFIG_NAME},,Key=Name,Value=AG:${AUTO_SCALING_GROUP_NAME}__LC:${LAUNCH_CONFIG_NAME})
